...
[![CI](https://github.com/chubbyts/chubbyts-dic-config/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/chubbyts/chubbyts-dic-config/actions/workflows/ci.yml)
...
```ts
npm i @chubbyts/chubbyts-dic-config@^2.3.0
```
